// Standalone preview of the typewriter-testimonial component.
// Not imported by the app — render <DemoOne /> in isolation to preview.
...
const DemoOne = () => {
  const testimonials = [
    ...
    {
      image:
        'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      audio: '',
